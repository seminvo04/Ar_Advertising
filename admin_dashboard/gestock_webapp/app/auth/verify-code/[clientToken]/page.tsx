...
export default function VerifyCodePage() {
  ...
  // const inputRefs: React.RefObject<HTMLInputElement | null>[] = Array(6).fill(null).map(() => useRef<HTMLInputElement | null>(null));
  ...
  const handleResendCode = async () => {
    setError('');
      try {
      const res: ResponseT<Record<string, string>> = await resendCode(clientToken as string);
      console.log(res);
      if (res.isSuccess) {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      console.log("reponse de credential");
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardDescription>
              ...
              Veuillez l&lsquo;entrer ci-dessous pour vérifier votre compte.
            </CardDescription>
          </CardHeader>
          <CardContent>
